      ...
      <div class="container-fluid" >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="indexBlogger.php">Home</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      <div class="p-3 mb-2 bg-light text-dark"><br>
        <div class="form-floating mb-3 ">
          ...
          <p>Unleash your creativity ✍️ and share your thoughts by crafting a blog post on any destination that you have been and inspired you in this section. Your experience matters, and this space is yours to write and share anything that you want!</p><br>
        </div>  
        <form class="row gy-2 gx-3 align-items-center" action="inputBlog.php" method="post" enctype="multipart/form-data">
          <div class="col-auto">
            <label class="visually-hidden" for="autoSizingInput">Titles</label>
            <input type="text" class="form-control" id="autoSizingInput" placeholder="Title" name="title" required>
          </div>
          <div class="form-floating">
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="blog" required></textarea>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Submit Blog</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    You are about to post your blog. Remember you can Delete any Blogs you've posted from 'My Blogs' section. 
                  </div>
