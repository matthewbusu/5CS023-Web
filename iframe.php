    ...
    <div class="container">
        ...
        <div class="p-3 mb-2 bg-light text-dark">
          <form class="row gy-2 gx-3 align-items-center">
            ...
            <iframe
                ...
                src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA_x-MqLZVyYffeazga41toBoY70vQ3f8A&q=<?php echo $country; ?>&zoom=7"
                allowfullscreen>
            </iframe>
          </form>
      </div>
      <?php 
        ...
        curl_setopt_array($curl, [
            CURLOPT_URL => "https://world-scuba-diving-sites-api.p.rapidapi.com/api/divesite?country=" . urlencode($name),
        ...
        echo "<h5 class='card-title'>$name's Dive Sites </h5><br>";
            ...
            for ($i = 0; $i < 5 && $i < count($divesites['data']); $i++) {
                ...
                <div id='flush-collapseTwo$i' class='accordion-collapse collapse' data-bs-parent='#accordionFlushExample'>
                  <div class='accordion-body'><iframe
                    ...
                    height='450'
                    frameborder='0' style='border:0'
                    src='https://www.google.com/maps/embed/v1/place?key=AIzaSyA_x-MqLZVyYffeazga41toBoY70vQ3f8A&q=$scubaLat,$scubaLng&zoom=13'
                    allowfullscreen>
                </iframe></div>
                </div><br>";
                } 
